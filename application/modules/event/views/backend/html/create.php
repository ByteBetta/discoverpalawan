                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6"><label><?= Translate::sprint("Lat", "") ?>
                                            <sup>*</sup></label> <input class="form-control" type="text" name="lat"
                                                                        id="lat"/></div>
                                    <div class="col-md-6"><label><?= Translate::sprint("Lng", "") ?> <sup>*</sup>
                                        </label> <input class="form-control" type="text" name="long" id="lng"/></div>
                                </div>
                            </div>
