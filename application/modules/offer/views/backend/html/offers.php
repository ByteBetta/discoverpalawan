                        ...
                        <div class="box-title" style="width : 100%;">
                            <div class="row">
                                ...
                                <div class="pull-right col-md-4">
                                    ...
                                    <form method="get" action="<?php echo empty($status) ? admin_url("offer/all_offers") : admin_url("offer/offers"); ?>">
                            ...
                            <?php if (count($list)) { ?>
                                <?php foreach ($list as $offer) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <?php if ($offer['status'] == 0 && GroupAccess::isGranted('offer', VALIDATE_OFFERS)) { ?>
                                            ...
                                            <?php } else if ($offer['status'] == 1 && GroupAccess::isGranted('offer', VALIDATE_OFFERS)) { ?>
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <?php
                                                    echo ' <a href="' . admin_url("offer/verify?id=" . $offer['id_offer']) . '&accept=1"><button type="button"  data-toggle="tooltip" title="Accept" class="btn btn-sm bg-green" ><i class="text-white mdi mdi-thumb-up" aria-hidden="true"></i></button></a> ';
                                                    echo ' <a href="' . admin_url("offer/verify?id=" . $offer['id_offer']) . '&accept=0"><button type="button"  data-toggle="tooltip" title="Decline" class="btn btn-sm  bg-red" ><i class="text-white fa fa-times" aria-hidden="true"></i></button></a>';
                                                    ?>
                                            ...
                                            <a href="<?= site_url("ajax/offer/delete?id=" . $offer['id_offer']) ?>"
                                               class="linkAccess" onclick="return false;">
                                                <button  data-toggle="tooltip" title="Delete" type="button" class="btn btn-sm">
                        ...
                        <div class="row">
                            <div class="col-sm-12 pull-right">
                                <div class="dataTables_paginate paging_simple_numbers" id="example2_paginate">
                                    ...
                                    ), empty($status) ? admin_url("offer/all_offers") : admin_url("offer/offers"));
