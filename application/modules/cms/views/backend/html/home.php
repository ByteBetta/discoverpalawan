        ...
        <div class="row">
                ...
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                                    <span class="info-box-text" data-toggle="tooltip"
                                          title="<?= Translate::sprint("Total_Stores", "") ?>">
            ...
            <div class="col-md-3 ">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                                <span class="info-box-text" data-toggle="tooltip"
                                      title="<?= Translate::sprint("Total_Events", "") ?>">
            ...
            <?php if (GroupAccess::isGranted('user', USER_ADMIN)): ?>
                ...
                <div class="col-md-3 ">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                                    <span class="info-box-text" data-toggle="tooltip"
                                          title="<?= Translate::sprint("Total_Customers", "") ?>">
            ...
            <div class="col-md-3 ">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                                <span class="info-box-text" data-toggle="tooltip"
                                      title="<?= Translate::sprint("Total_Campaigns", "") ?>">
                    ...
                    <div class="box box-solid">
                        ...
                        <?php if (count($stores) > 4) { ?>
                            <div class="box-footer text-center">
                                <a href="<?= admin_url("store/stores") ?>"
                                   class="uppercase"><?= Translate::sprint("View_all_stores", "View all stores") ?> </a>
                            </div>
                        <?php } ?>
                        <!-- /.box-footer -->
                    </div>
